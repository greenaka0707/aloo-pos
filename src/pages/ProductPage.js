...
export default function ProductPage() {
  setTimeout(async () => {
    ...
    // ==========================================================================
    // UPDATE UTAMA: Fungsi render data dengan efek animasi geser horizontal
    // ==========================================================================
    const renderList = (filteredItems) => {
      // Pemicu awal: Beri efek geser keluar (slide out ke kiri)
      container.classList.add("page-leave");

      // Beri delay mikro 150ms biar list lama selesai bergeser dulu baru diganti datanya
      setTimeout(() => {
        ...
        // Cabut status leave, pasang status enter (siap meluncur dari kanan)
        container.classList.remove("page-leave");
        container.classList.add("page-enter");

        // Flush class enter di frame berikutnya agar browser memicu animasi meluncur ke tengah
